...
| DFlash2 and compact Bonsai PTQ1 | Trained DFlash companion, row-batched target verification, strict Prism/Hadamard artifacts, direct compact PTQ1 Metal projections/embeddings | Matched 512/256 Release runs reached a 32.555 tokens/s median with exact ordinary parity, 95.24% of Splash's 34.181; width eight and Q8 paged KV changed greedy output and remain disabled; compact Bonsai matched the affine artifact's token hash with lower peak MLX memory but lower throughput; no physical-iPhone run was available |
